<?php
session_start();
$password = "7c6b7e40997b9a28a0f0e376e298034a";
...
?>
    ...
    <title>TakitaxKitux Login</title>
    <style>
        body {
            margin: 0;
            padding: 0;
            ...
            align-items: center;
            background: url('https://images2.imgbox.com/67/80/2efs4XOs_o.png') no-repeat center center;
